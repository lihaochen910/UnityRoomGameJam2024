    ...
    public static class JSONSerializer
    {
        ...
        public static string Serialize(Type type, object instance, List<UnityEngine.Object> references = null, bool pretyJson = false) {
            ...
            lock ( serializerLock ) {
                ...
                var r = serializer.TrySerialize(type, instance, out var data, overrideConverterType).AssertSuccess();
                if ( r.HasWarnings ) {
                    UnityEngine.Debug.LogWarning( r.ToString() );
                }
        ...
        static object Internal_Deserialize(Type type, string json, List<UnityEngine.Object> references, object instance) {
            ...
            lock ( serializerLock ) {
                ...
                if ( Threader.applicationIsPlaying ) {
                    ...
                    if ( json != null && !dataCache.TryGetValue(json, out data) ) {
                ...
                if ( r.HasWarnings ) { UnityEngine.Debug.LogWarning(r.ToString()); }
