...
using System.Linq;
using Bang.Unity.Serialization.Converters;
using Bang.Unity.Serialization.DirectConverters;
    ...
    public class fsSerializer
    {
        ...
        public fsSerializer() {
            ...
            _availableConverters = new List<fsConverter>
            {
                ...
                new fsImmutableArrayConverter { Serializer = this },
                
                new BangStateMachineComponent_Converter { Serializer = this },
                new BangInteractiveComponent_Converter { Serializer = this },
            ...
            AddConverter(new Color_DirectConverter());

            AddConverter(new Vector2_DirectConverter());
            AddConverter(new Vector3_DirectConverter());
            AddConverter(new Vector4_DirectConverter());
            AddConverter(new Vector2Int_DirectConverter());
            AddConverter(new Vector3Int_DirectConverter());
            AddConverter(new Matrix4x4_DirectConverter());
        }
        ...
        fsResult Internal_Deserialize(fsData data, Type storageType, ref object result, Type overrideConverterType) {
            ...
            if ( IsTypeSpecified(data) ) {
                ...
                do {
                    ...
                    var type = ReflectionHelper.GetType(typeName, storageType);
        ...
        void TryDeserializeMigration(ref object currentInstance, ref fsData currentData, Type previousType, object previousInstance) {
            if ( currentInstance is IMigratable && currentData.IsDictionary ) {
                ...
                migrateMethod.Invoke(currentInstance, ReflectionHelper.SingleTempArgsArray(previousInstance));
